...
class SmartIssuePrioritizer:
    ...
    def __init__(self):
        ...
        self.effort_matrix = {
            ...
            'image_missing_alt': Effort.LOW,
            'h1_mancante': Effort.MINIMAL,
            'h1_multipli': Effort.LOW,
            'canonical_mancante': Effort.LOW,
            'broken_internal_links': Effort.MEDIUM,
            'poor_core_web_vitals': Effort.HIGH,
            'missing_schema_markup': Effort.MEDIUM,
            'ottimizzazione_mobile_scarsa': Effort.HIGH,
            'etichette_form_mancanti': Effort.MEDIUM,
            'contenuto_scarso': Effort.SEVERE,
            'contenuto_insufficiente': Effort.SEVERE,
